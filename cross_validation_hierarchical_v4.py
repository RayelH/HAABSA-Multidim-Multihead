...
def cross_val(number_of_folds=10, compute_folds=False, multidim=False, multihead=False, multidimmultihead=False,
    ...
    if multidim:
        ...
        for i in range(number_of_folds):
            min_training_loss, max_training_accuracy, min_test_loss, max_test_accuracy, training_losses, train_accuracies, test_losses, test_accuracies = lcrModelAlt_hierarchical_v4_cross.main(BASE_train + str(i) + '.txt', BASE_val + str(i) + '.txt',
        ...
        with open("cross_results_" + str(FLAGS.year) + "/hierarchical_v4" + str(FLAGS.year) + '.txt', 'a') as result:
