...
tf.app.flags.DEFINE_integer('heads', 2, 'number of heads')
...
tf.app.flags.DEFINE_string("train_path", "data/" + str(FLAGS.embedding_type) +str(FLAGS.embedding_dim)+'traindata'+str(FLAGS.year)+".txt", "train data path")
tf.app.flags.DEFINE_string("test_path", "data/" + str(FLAGS.embedding_type) + str(FLAGS.embedding_dim)+'testdata'+str(FLAGS.year)+".txt", "formatted test data path")
...
tf.app.flags.DEFINE_string("remaining_train_path", "data/programGeneratedData/"+str(FLAGS.embedding_dim)+'remainingtraindata'+str(FLAGS.year)+".txt", "formatted remaining test data path after ontology")
